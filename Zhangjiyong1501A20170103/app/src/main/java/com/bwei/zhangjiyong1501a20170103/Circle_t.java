...
public class Circle_t extends View {
    ...
    public Circle_t(Context context) {
        super(context);
    }

    public Circle_t(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Circle_t(Context context, AttributeSet attrs, int defStyleAttr) {
