...
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Circle);//TypedArray是一个数组容器
//
//        float textSize = a.getDimension(R.styleable.Circle_textSize, 30);//防止在XML文件里没有定义，就加上了默认值30
//
//        int textColor = a.getColor(R.styleable.Circle_textColor, 0xFFFFFFFF);//同上,这里的属性是:名字_属性名
//
//        paint=new Paint();
//
